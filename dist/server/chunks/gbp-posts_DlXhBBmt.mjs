...
import 'piccolore';
import { L as renderTemplate, aY as renderHead } from './sequence_C7YAHkIp.mjs';
import 'clsx';
...
Каждый ребёнок уехал домой с реальным проектом — не сертификатом, а работающим продуктом.
...
За 10 дней ребёнок с нуля напишет работающий Python-проект:
→ Telegram-бот
→ Парсер сайтов
→ Игра с базой данных
