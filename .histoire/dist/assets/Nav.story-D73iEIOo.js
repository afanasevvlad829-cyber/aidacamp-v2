...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["BlockFrame"], {
    id: "blocks-nav--default",
    title: "Blocks / Nav",
    height: 420
  });
}
_sfc_main.__file = "src/histoire/Nav.story.vue";
const Nav_story = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/root/aidaplus-dev-serverwork/src/histoire/Nav.story.vue"]]);
export {
  Nav_story as default
};
