const __resolved__virtual_storySource_tailwind = `
import 'histoire-style'
import './style.css'
import { createApp, h, markRaw, ref } from "file:///root/aidaplus-dev-serverwork/node_modules/histoire/dist/node/vendors/vue.js"
import {
  HstColorShades,
  HstTokenList,
  HstTokenGrid,
  ...
  HstTextarea,
  HstNumber,
} from "file:///root/aidaplus-dev-serverwork/node_modules/histoire/dist/node/vendors/controls.js"
...
const config = markRaw({
  "theme": {
    ...
    "backgroundImage": {
      ...
      "hero-overlay": "linear-gradient(90deg, rgba(7,12,22,0.84) 0%, rgba(7,12,22,0.55) 34%, rgba(7,12,22,0.14) 64%, rgba(7,12,22,0.04) 100%)",
      "hero-overlay-bottom": "linear-gradient(180deg, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.08) 45%, rgba(0,0,0,0.32) 100%)"
    },
    "backgroundOpacity": {
      "0": "0",
      "5": "0.05",
    ...
    "boxShadow": {
      ...
      "cardHover": "0 14px 32px rgba(15, 23, 42, 0.08)",
      "booking": "0 14px 40px rgba(15, 23, 42, 0.10)",
      "heroNav": "0 10px 30px rgba(0, 0, 0, 0.12)",
      "cta": "0 10px 24px rgba(255, 139, 31, 0.28)"
    },
    "boxShadowColor": {
      "inherit": "inherit",
      "current": "currentColor",
