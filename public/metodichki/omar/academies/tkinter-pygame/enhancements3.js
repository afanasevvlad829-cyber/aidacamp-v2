/* ===== Tkinter & Pygame Academy — Fun Pack v3 (revised) =====
...
(function(){
  ...
  const CAT_TIPS = {
    quiz: [
      ...
      'В Tkinter каждый виджет должен быть на своём месте 🪟',
    ...
    lesson: [
      ...
      'Лучший способ выучить GUI — писать окна и игры 🎮',
  ...
  const MOTIVATIONS = [
    '🚀 Новая тема — новые суперсилы!','🐍 Поехали покорять Tkinter и Pygame!',
  ...
  function checkNewTopic(){
    ...
    if (!tabs && /Debug|AI|Достижения|Добро пожаловать|Tkinter & Pygame Academy/i.test(title)){
