/* ===== Java Academy — Fun Pack v3 (revised) =====
...
(function(){
  ...
  const DONE_MSGS = [
    '🎉 Отличная работа!','🚀 Поехали дальше!','⭐ Супер!','☕ Java гордится тобой!',
  ...
  const CAT_TIPS = {
    quiz: [
      ...
      'В Java каждая инструкция заканчивается ; 😉',
    ...
    lesson: [
      ...
      'Лучший способ выучить Java — писать Java ☕',
  ...
  const MOTIVATIONS = [
    '🚀 Новая тема — новые суперсилы!','☕ Поехали покорять Java!',
    '💡 Готов(а) узнать что-то крутое?','🎯 Сфокусируйся — и у тебя всё получится!',
    '⚡ Каждый шаг приближает тебя к мастерству!','🌟 Юный Java-программист в работе!',
  ...
  function checkNewTopic(){
    ...
    if (!tabs && /Debug|AI|Достижения|Добро пожаловать|Java Academy/i.test(title)){
