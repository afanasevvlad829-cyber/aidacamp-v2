/* ===== Java Academy — Fun Pack v2 (timers, sounds, walkers, profile) ===== */
(function(){
  'use strict';
  ...
  function buildProfileData(){
    ...
    const name       = (s.profile && (s.profile.fullName || s.profile.name)) || 'Юный Java-программист';
  ...
  function openProfile(){
    ...
    back.innerHTML = `
      <div class="pa-modal" style="position:relative">
        ...
        <h2>👤 ${name}</h2>
        <div class="sub">Твоя личная карта прогресса в Java Academy</div>
