...
# Использование: ./scripts/vps-start-agent.sh "<задача>"

TASK="${1:-}"

if [[ -z "$TASK" ]]; then
  echo "Использование: $0 \"<задача>\""
  echo ""
