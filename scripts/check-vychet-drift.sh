...
# Плюс бан «5 434» — везде, где рядом (в той же строке) есть денежный/вычетный контекст
# (₽, слова вычет/верн/ФНС/НДФЛ/vychet/deduct) — не безусловный греп, иначе ложные
# срабатывания на md5-хешах.
set -euo pipefail
