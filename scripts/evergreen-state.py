...
Плановый workflow (.github/workflows/evergreen-refresh.yml) сравнивает
сигнатуру на сегодня с сигнатурой на дату последнего успешного Deploy
(дата передаётся аргументом: `evergreen-state.py 2026-08-04`); при отличии
диспатчит обычный деплой, и статический сайт пересобирается со свежей датой.
Марк-файла состояния нет: прямой коммит в dev невозможен из-за branch
protection (см. комментарий в самом воркфлоу, 2026-08-07).
