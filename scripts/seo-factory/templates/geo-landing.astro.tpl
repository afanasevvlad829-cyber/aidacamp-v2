...
const sections = [
  ...
  },
  {
    ...
    list: [
      ...
      "Лицензия Минобрнауки, документы для налогового вычета до 5 434 ₽"
    ]
  },
  {
    ...
    <script type="application/ld+json" set:html={JSON.stringify({
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "От 48 000 ₽ за 7 дней. Популярные смены: 14 дней — 99 000 ₽, 13 дней — 89 400 ₽. Включены проживание, питание, IT-программа, бассейн. Налоговый вычет 13% — до 5 434 ₽." }
        }
      ]
    })} />
    <CourseSchema
