...
function generateNchContent(cluster, rag = {}) {
  ...
  const intro2 = `Программа включает треки по Python, AI и нейросетям, Minecraft Education, `
    ...
    + `Стоимость путёвки от 48 000 ₽, налоговый вычет 13% — до 5 434 ₽.`;
  ...
  const faq2a = `Стоимость путёвки от 48 000 ₽ (7 дней) до 99 000 ₽ (14 дней). `
...
function generateGeoContent(cluster, rag = {}) {
  ...
  const intro2 = `Программы: Python, AI и нейросети, Minecraft Education, Roblox Studio, 3D-моделирование. `
    ...
    + `Путёвка от 48 000 ₽, налоговый вычет 13% — до 5 434 ₽.`;
  ...
  const faq3a = `От 48 000 ₽ за 7 дней. Смены 10, 13 и 14 дней — 74 900–99 000 ₽. `
    + `Включены питание, проживание, IT-программа. Налоговый вычет 13% — до 5 434 ₽.`;
