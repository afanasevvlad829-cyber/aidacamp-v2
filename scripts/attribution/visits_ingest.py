...
_BOT_RE = re.compile(r"bot|crawl|spider|scrapy|externalagent|amazonbot|ahrefs|semrush|duckduck|preview|monitor|uptime|python|curl|wget|go-http|java/|okhttp|headless|phantom|slurp|bingpreview|facebookexternalhit", re.I)
