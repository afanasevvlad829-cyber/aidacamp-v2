...
for (const width of [390, 414, 600, 744, 828]) {
  await sharp('public/images/hero-mobile-bean-v3-828.avif').resize({ width }).avif({ quality: 19, effort: 9, chromaSubsampling: '4:2:0' }).toFile(`public/optimized-media/hero-mobile-optimized-${width}.avif`);
}
