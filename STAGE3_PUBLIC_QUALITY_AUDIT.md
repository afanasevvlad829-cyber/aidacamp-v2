...
- A separate core-business coverage gate now protects the tested pricing, shifts, permissions, session, attribution, and formatting modules with minimums of 85% statements/lines and 80% branches/functions.
