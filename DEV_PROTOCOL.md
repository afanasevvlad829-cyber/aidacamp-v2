...
- ❌ «роботы» / «робототехника» как заявленное направление программы (подтверждено владельцем 26.07.2026) — про роботов не пишем, пишем «нейросети». Слово «робот» само по себе не запрещено в других контекстах (пример 3D-модели персонажа, «робот-агент» — реальная механика Minecraft Education) — запрещено только выдавать роботов/робототехнику за часть учебной программы
