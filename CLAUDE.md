...
> **⚡ Правило №1 (разработка):** вся работа по сайту — на VPS: `./scripts/vps-start-agent.sh "<задача>"`. Локально только хотфиксы владельца. Подробности — [`DEV_PROTOCOL.md`](DEV_PROTOCOL.md) → «Правило №1 — ВСЯ разработка на VPS».
