...
### Основные правила по каналам

- **[_notes/Библиотека знаний/](_notes/Библиотека%20знаний/README.md)** — корневой индекс
  - [Яндекс.Директ — основные правила.md](_notes/Библиотека%20знаний/Яндекс.Директ%20—%20основные%20правила.md) — структура кампаний, минус-слова, РСЯ, ставки
  - [VK Ads — основные правила.md](_notes/Библиотека%20знаний/VK%20Ads%20—%20основные%20правила.md) — структура VK-кампаний, аудитории, ограничения
  - [SEO — основные правила.md](_notes/Библиотека%20знаний/SEO%20—%20основные%20правила.md) — мета, H1-H6, структура, ссылки

### Инструкции и контекст для агентов (с примерами API)

- **[_notes/MCP и инструкции/Yandex Direct — основы для агентов.md](_notes/MCP%20и%20инструкции/Yandex%20Direct%20—%20основы%20для%20агентов.md)** — промпт-контекст для работы с Direct API:
  - Структура Direct API v5 (campaigns, ad_groups, keywords, ads)
  - Паттерны запросов и обработки ошибок
  - Примеры создания/редактирования кампаний
  - Лимиты API и rate limiting

- **[_notes/MCP и инструкции/VK Ads — основы для агентов.md](_notes/MCP%20и%20инструкции/VK%20Ads%20—%20основы%20для%20агентов.md)** — промпт-контекст для работы с VK API:
  - Структура VK Ads API (ad_plans, ad_groups, banners)
  - Паттерны запросов и параметры объявлений
  - Примеры создания/редактирования кампаний и объявлений
  - Демографический и интересный таргетинг в VK

- **[_notes/АйДаКемп/Клиенты/Портрет клиента.md](_notes/АйДаКемп/Клиенты/Портрет%20клиента.md)** — профиль целевой аудитории:
  - Глубинная мотивация (сегмент целевой аудитории)
  - Боли и страхи родителей
  - Возраст, доход, поведение
  - Как эта информация влияет на выбор стратегии и креативов

### Как использовать эту документацию

**Перед любой задачей по Директу, VK или SEO:**
1. Откройте соответствующий файл из раздела «Основные правила»
2. Если работаете с API — откройте файл из раздела «Инструкции для агентов» (там примеры и паттерны)
3. Если пишете креатив или делаете аудиторию — прочитайте «Портрет клиента»

**Правило документирования:** любой инсайт из сессии, аудита или инцидента — фиксировать в соответствующий файл в разделе «Best practices из нашего опыта» с датой и структурой **Симптом / Причина / Решение / Правило**. Разовые ошибки агента повторяются именно потому, что выводы не записаны.
