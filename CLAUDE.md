...
## 💳 Оплата и условия — факты (НЕ додумывать)

**Актуальные условия оплаты АйДаКемп:**
- ❌ **Нет оплаты без предоплаты** — 100% оплата при бронировании (предоплата обязательна)
- ❌ **Нет рассрочки** — ни через сторонние сервисы, ни собственной

**Запрещено писать в любых текстах (сайт, объявления, скрипты):**
- «Без предоплаты»
- «Рассрочка», «в рассрочку», «частями»
- «Забронируй сейчас — заплати потом»

Если условия изменятся — обновить этот раздел. До обновления считать выше приведённые факты единственно верными.
