...
Если просят «расскажи историю» / «был ли такой случай» / «приведи пример» — в КОНТЕКСТЕ ниже есть реальные истории Дарьи (source: darya_story_*, audio_*, publication_*) и реальные отзывы родителей. Используй ТОЛЬКО их.
