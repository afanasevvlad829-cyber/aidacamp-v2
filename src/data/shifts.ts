...
export const mainShifts: Shift[] = [
  ...
  // зимние каникулы у всех школ практически совпадают, риск сдвига минимален.
  {
    ...
    duration: '10 дней',
    // highlighted переехал сюда со Смены 3 (07.09.2026): та ушла в архив вместе
    // с летом, и выделенной смены не осталось ни одной. Зимняя — в активной
    // продаже с 27.08, её и выделяем. Решение владельца.
    highlighted: true,
    status: 'идёт запись',
    statusType: 'available',
