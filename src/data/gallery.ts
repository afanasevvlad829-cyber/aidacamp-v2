...
export const images: Record<string, { src: string; alt: string }[]> = {
  ...
  pool: [
    ...
    { src: '/images/gallery/pool-noodles.avif', alt: 'Дети с нудлами в бассейне лагеря АйДаКемп' },
  ...
  sport: [
    { src: '/images/gallery/sport-goal.avif', alt: 'Футбольные ворота в лагере АйДаКемп' },
    { src: '/images/gallery/sport-football.avif', alt: 'Футбол в детском лагере АйДаКемп' },
    { src: '/images/gallery/sport-ball.avif', alt: 'Активный спорт в лагере АйДаКемп' },
    { src: '/images/gallery/sport-field.avif', alt: 'Спортивная площадка лагеря АйДаКемп' },
  ],
  study: [
    ...
    { src: '/images/gallery/study-pitch.avif', alt: 'Питч проекта в IT-лагере АйДаКемп' },
  ],
  food: [
  ...
  territory: [
    ...
    { src: '/images/gallery/sport-field.avif', alt: 'Спортивное поле лагеря АйДаКемп' },
  ],
};
