...
export const members: TeamMember[] = [
  ...
  {
    name: 'Варвара Мухортова',
    role: 'руководитель смены',
    photo: '/images/team/team-varvara-main-01.avif',
    alt: 'Варвара Мухортова — руководитель смены АйДаКемп',
    bio: 'главный человек смены: выстраивает диалог с родителями и администрацией, держит ритм лагеря и следит за тем, чтобы каждый день был насыщенным и спокойным.',
  },
  {
    name: 'Никита Брагин',
