(function () {
  ...
  var CONTENT_MAP = {
    ...
    footer: {
      brand: "© AiDaCamp",
      tagline: "Лагерь в Подмосковье для детей 7-15 лет"
    },
    ui: {
      prev: "Назад",
      next: "Вперёд",
  ...
  var AGE_PROFILES = [
    {
      ...
      subtitle: "Для детей 7-15 лет: свои IT-проекты, бассейн и спорт каждый день, внутренняя экономика с лагерной валютой.",
    ...
    },
    {
      ...
      max: 14,
      title: "AiDaCamp: IT-лагерь без телефонов в Подмосковье",
      subtitle: "Для детей 13-15 лет: AI-интенсив, хакатоны, презентация проектов и продуктовый подход.",
      progress: "49 % - мест занято",
      ageText: "Возраст: 13-15 лет -> AI + проектная работа",
      benefits: [
  ...
  var SHIFTS = [
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "AI-практика, анализ данных и защита мини-проекта."
      },
    ...
    },
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "AI-инструменты, продуктовые задачи и командная разработка."
      },
      nextCta: "Смотреть даты и цены смен",
      benefits: [
    ...
    },
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "AI-интенсив, хакатоны и проектная защита."
      },
      nextCta: "Смотреть даты и цены смен",
      benefits: [
    ...
    },
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "Длинная смена: AI-кейсы, командные проекты и защита."
      },
      nextCta: "Смотреть даты и цены смен",
      benefits: [
    ...
    },
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "Летний интенсив: AI-проекты, аналитика и защита результатов."
      },
      nextCta: "Смотреть даты и цены смен",
      benefits: [
    ...
    },
    {
      ...
      descriptions_by_age: {
        ...
        "13-15": "Финальная смена: AI-кейсы, проектная практика и презентация."
      },
      nextCta: "Смотреть даты и цены смен",
      benefits: [
