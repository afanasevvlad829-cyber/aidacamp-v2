# Программа «Тревожный родитель» — расписание на 10 дней · АйДаКемп

Source: https://aidacamp.ru/tarif-trevozhniy-roditel/
...
| `extracted/tokens.json` | Design tokens: 20 colors, 3 fonts, 8 headings, 3 CTAs |
...
- **Colors**: #FFFFFF (bg-light), #6B7280 (neutral), #0D1A2B (accent), #4B5263 (neutral), #0F172B (accent), #FB64B6 (accent), #E5E7EB (bg-light), #FFB900 (surface-light), #FCCEE8 (surface-light), #314158 (accent)
- **Fonts**: Montserrat (600), Inter (100-900 variable), Open Sans CoMagic (400,600)
